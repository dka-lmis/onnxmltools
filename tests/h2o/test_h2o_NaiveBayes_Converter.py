...
"""
Tests Principal Component Analysis (NaiveBayes) converter
https://docs.h2o.ai/h2o/latest-stable/h2o-docs/data-science/NaiveBayes.html
"""
import os
import unittest

from h2o import h2o
from h2o.estimators import H2OPrincipalComponentAnalysisEstimator, H2ONaiveBayesEstimator
